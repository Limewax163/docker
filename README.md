...
> [!NOTE]
> В docker-compose можно использовать шаблоны, которые будут добавляться в определенно указанном месте
> (или сразу в нескольких. Это удобно если для группы сервисов указываются одни и те же сущности.
