...
Настройка докера на прием входящих подключений к сокету на хосте "tcp://0.0.0.0:2375" без TLS либо "tcp://0.0.0.0:2376" с TLS (необходимо генерить сертификаты на хосте и добавлять необходимые сертификаты клиенту)
но это гавно судя по всему не работает, [обходной вариант](https://github.com/Limewax163/docker/blob/main/external_docker_socker_connection.md)
